...
type User struct {
	...
	UpdeatedAt time.Time `boil:"updeated_at" json:"updeated_at" toml:"updeated_at" yaml:"updeated_at"`
...
var UserWhere = struct {
	...
	UpdeatedAt whereHelpertime_Time
}{
	ID:         whereHelperuint{field: "`users`.`id`"},
	Name:       whereHelperstring{field: "`users`.`name`"},
	Icon:       whereHelperstring{field: "`users`.`icon`"},
	Profile:    whereHelperstring{field: "`users`.`profile`"},
	CreatedAt:  whereHelpertime_Time{field: "`users`.`created_at`"},
	UpdeatedAt: whereHelpertime_Time{field: "`users`.`updeated_at`"},
}
...
var (
	userAllColumns            = []string{"id", "name", "icon", "profile", "created_at", "updeated_at"}
	userColumnsWithoutDefault = []string{"name", "icon", "profile", "created_at", "updeated_at"}
