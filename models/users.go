...
var (
	userAllColumns            = []string{"id", "name", "icon", "profile", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"name", "icon", "profile", "created_at", "updated_at", "deleted_at"}
...
func (o *User) Tweets(mods ...qm.QueryMod) tweetQuery {
	...
	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`tweets`.*"})
	}
